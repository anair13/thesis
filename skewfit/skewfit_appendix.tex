...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=1\linewidth]{skewfit/figures/plots/power_ablation_square_with_inset.pdf}
  \vspace{-.05in}
...
\end{figure}
 ...
 \begin{figure}[H]
     \vspace{0.1in}
         \centering
         \includegraphics[width=0.8\linewidth]{skewfit/figures/plots/variance.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.25\textheight]{skewfit/figures/vae_dumps/rig-real-world-v2-exp-samples.png}
    \hspace{.3 in}
    \includegraphics[width=0.25\textheight]{skewfit/figures/vae_dumps/skew-fit-real-world-v2-exp-samples.png}
    \fcaption{
