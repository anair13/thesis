...
%   \vspace{-0.6cm}
  \begin{center}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=0.98\textwidth]{awac/figures/rig/pusher_random-crop.pdf}
        
        \includegraphics[width=0.98\textwidth]{awac/figures/rig/pusher_random_legend-crop.pdf}
    \end{subfigure}
  \end{center}
  \vspace{0.1cm}
  \caption{
