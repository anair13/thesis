...
\begin{figure}
    \centering
    % \includegraphics[width=0.9\linewidth]{img/main_fig.jpg}
    % \includegraphics[width=\linewidth]{img/main_fig_v5.pdf}
...
Many prior works have also focused on learning controllable and disentangled representations~\cite{schmidhuber1992learning,chen2016infogan,cheung2014discovering,reed2014learning,desjardins2012disentangling,thomas2017independentlycontrollable}.
...
\begin{figure}
    \centering
    \includegraphics[height=0.19\linewidth]{img/reacher_baselines_legend_right.pdf}
    \includegraphics[height=0.19\linewidth]{img/pusher_baselines}
    \includegraphics[height=0.19\linewidth]{img/multiobj_pusher_baselines.pdf}
    \vspace{-0.1in}
...
We compare our method with the following prior works.
...
\begin{wrapfigure}{r}{5cm}
    \centering
    \vspace{-0.2in}
    \includegraphics[width=\linewidth]{img/pusher_relabeling_ablation_main.pdf}
    \vspace{-0.2in}
...
% Definitely keep this out for the NIPS rebuttal
% \section{Acknowledgements}

% We would like to thank Aravind Srinivas and Pulkit Agrawal for useful discussions, and Alex Lee for helpful feedback on an initial draft of the paper.
% We would also like to thank Carlos Florensa for making multiple useful suggestions in later version of the draft.
% This work was supported by the National Science Foundation IIS-1651843 and IIS-1614653, a Huawei Fellowship, Berkeley DeepDrive, Siemens, and support from NVIDIA.
